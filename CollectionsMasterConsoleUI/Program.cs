...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                Console.WriteLine("Which number would you like from this list?");
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"This number is present in this list");
            }
            else
            {
                Console.WriteLine($"Unfortunately this number is not present in this list");
